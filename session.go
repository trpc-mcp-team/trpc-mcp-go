...
// Key for storing server instance in context
...
// GetSessionFromContext retrieves a session from the context
...
// GetServerFromContext retrieves the server instance from the context
